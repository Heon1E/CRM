...
**한글이 깨지는 지점이 두 군데 있다. 둘 다 실제로 나온다:**
...
**실측(2026-08, 연락처 1,099명):** 회사명 일치 4명 / 후보 10명 / 단서 없음 1,085명.
**휴대폰 연락처에 거래처 담당자가 거의 없다** — 회사명 칸이 채워진 것이 103명뿐이고
그나마도 노무법인·특허사무소·유니폼처럼 거래처가 아닌 곳이 대부분이다.
대신 이름에 회사를 적는 습관이 있다(`남양화학 장부장`, `인지산업 사장`) —
후보 제안이 그것을 잡는다.

그래서 이 기능은 **한 번에 다 채우는 도구가 아니라, 거래처를 검색해 하나씩 붙이는
도구**로 만들었다. 단서 없는 1,085명은 접어 두고 필요할 때 펼친다.
