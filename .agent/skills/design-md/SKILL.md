...
## Usage Example
To use this skill for a project:

1. **Retrieve project information:**
   ```
   Use the Stitch MCP Server to get the target project
   ```

2. **Get the screen details:**
   ```
   Retrieve the screen's code, image, and screen object information
   ```
